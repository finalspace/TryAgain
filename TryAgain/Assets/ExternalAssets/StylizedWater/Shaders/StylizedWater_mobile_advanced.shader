    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                fixed WaveSpeed = (node_8305.g*(_Wavesspeed*0.1));
                ...
                float3 node_9167 = (1.0-(1.0-node_4911.rgb)*(1.0-node_49111.rgb));
                fixed3 Normals = node_9167;
...
////// Specular:
                ...
                fixed2 rimPanningU = (rimTiling+node_7911*float2(1.1,0));
                float4 rimTexR = tex2D(_Shadermap,rimPanningU);
                fixed2 rimPanningV = (rimTiling+node_7911*float2(0,0.9));
                ...
                float node_4005 = 1.0;
                fixed2 HighlightPanningV = (WavePanningV*_SurfaceHightlighttiling);
                float4 node_5469 = tex2D(_Shadermap,HighlightPanningV);
                fixed2 HightlightPanningU = (WavePanningU*_SurfaceHightlighttiling);
