...
Shader "StylizedWater/Desktop" {
    Properties {
        ...
        _Wavetint ("Wave tint", Range(0, 1)) = 0
        ...
        [HideInInspector][MaterialToggle] _UseIntersectionHighlight ("UseIntersectionAsHighlight", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform fixed _UseIntersectionHighlight;
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float SurfaceHighlights = saturate((_SurfaceHighlight*lerp( step(_Surfacehightlightsize,(HighlightPanningV_Tex.r-HightlightPanningU_Tex.r)), (1.0 - lerp( HightlightPanningU_Tex.r, (HighlightPanningV_Tex.r*HightlightPanningU_Tex.r), _HighlightPanning )), _UseIntersectionHighlight )));
                float3 Normals = lerp(WaveNormalBlend,float3(0,0,1),SurfaceHighlights);
...
////// Specular:
                ...
                fixed2 rimPanningU = (rimTiling+node_2352*float2(1.1,0));
                float4 rimU_Tex = tex2D(_Shadermap,rimPanningU);
                fixed2 rimPanningV = (rimTiling+node_2352*float2(0,0.9));
